...
def prepare_dataset():
    ...
    positive_words = ["wealth", "king", "famous", "strong", "excellent", "gain", "happiness", "honor"]
    negative_words = ["poor", "sick", "disease", "death", "enemy", "loss", "grief", "weak", "bad"]
    ...
    planet_map = {"Sun":0, "Moon":1, "Mars":2, "Mercury":3, "Jupiter":4, "Venus":5, "Saturn":6, "Rahu":7, "Ketu":8}
    zodiac_map = {"Aries":0, "Taurus":1, "Gemini":2, "Cancer":3, "Leo":4, "Virgo":5, 
